...
public interface IThreadService
{
    ...
    public Task<(
        ...
        Message userMessage
        )> AddMessageToThreadAsync(Guid ThreadId, CreateMessageDto createMessageDto, CancellationToken cancellationToken);

    public Task<ICollection<GetThreadDto>> GetAllThreadsForUserAsync(Guid userId, CancellationToken cancellationToken);

    public Task<ICollection<GetMessageDto>> GetAllMessagesForThreadOrderedByCreatedAtAsync(Guid threadId, CancellationToken cancellationToken);
